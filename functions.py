...
AIRTABLE_API_KEY = "Bearer your_api_key_here"
...
def create_lead(name, phone, wechat,address,summary,intention):
  url = "https://api.airtable.com/v0/appBRsq9bR6ayGi6x/tbllNEBV6IVoJnSl9"  # 替换自己的
  headers = {
...
def create_assistant(client):
  ...
  if os.path.exists(assistant_file_path):
    ...
    file = client.files.create(file=open("ziliao.txt", "rb"),
                               purpose='assistants')
